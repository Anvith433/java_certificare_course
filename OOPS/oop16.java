...
interface Smartwatch extends Watch {
    ...
    void displayHeartRate(int single_value_heartRate);
    // Complete the interface implementation
}

class IWatch implements Smartwatch {
    public void displayTime(int hour,int minutes,int seconds)
    {
    ...
    public void displayHeartRate(int single_value_heartRate)
    {
        System.out.println("Heart Rate"+":"+" "+single_value_heartRate+" "+"bpm");
    }
